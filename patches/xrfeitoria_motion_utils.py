...
def load_amass_motion(input_amass_smpl_x_path: PathLike, is_smplx: bool = True, insert_rest_pose: bool = True) -> Union[SMPLMotion, SMPLXMotion]:
    ...
    if is_smplx:
        src_motion = SMPLXMotion.from_amass_data(amass_smpl_x_data, insert_rest_pose=insert_rest_pose)
    else:
        src_motion = SMPLMotion.from_amass_data(amass_smpl_x_data, insert_rest_pose=insert_rest_pose)
    return src_motion
